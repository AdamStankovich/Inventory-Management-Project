...
<body>
    ...
    <form class="form2">
        <h1 id='title'>Statesboro Switch Passive</h1>
        <hr>

        <div id='add'>
            <a href='addswitchpassive.php' style='margin-bottom: 50px;'>Add New Equipment</a><br>
        </div>

        <form action="StatesboroSwitchPassive.php">
            ...
            <table>
                ...
                if (!empty($_GET["search"])) {
                    $search = $_GET["search"];
                    $query = "SELECT * FROM StatesboroSwitchPassive WHERE Name LIKE '%$search%'
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <button id='modallist'><a class='nounderlineedit' id='modallink3'
                        href='editpassive.php'>Edit</a></button>
                <br>

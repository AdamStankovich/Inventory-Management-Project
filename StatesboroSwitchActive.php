...
<body>
    ...
    <form class="form2">
        <h1 id='title'>Statesboro Switch Active</h1>
        <hr>

        <div id='add'>
            <a href='add.php' style='margin-bottom: 50px;'>Add New Equipment</a><br>
        </div>
        ...
        <form action="StatesboroSwitchActive.php">
            ...
            <table>
                ...
                if (!empty($_GET["search"])) {
                    $search = $_GET["search"];
                    $query = "SELECT * FROM StatesboroSwitchActive WHERE Name LIKE '%$search%'

...
<body>
    ...
    <form class="form2">
        <h1 id='title'>Statesboro Accessories</h1>
        <hr>

        <div id='add'>
            <a href='addaccessories.php' style='margin-bottom: 50px;'>Add New Equipment</a><br>
        </div>

        <form action="StatesboroAccessories.php">
            ...
            <table>
                ...
                if (!empty($_GET["search"])) {
                    $search = $_GET["search"];
                    $query = "SELECT * FROM StatesboroAccessories WHERE Name LIKE '%$search%'
        ...
        ";
                ...
                // ------------------------------------------------------- NO SEARCH --------------------------------------------------------------------
                    ...
                    $query = "SELECT * FROM StatesboroAccessories";
                    $result = mysqli_query($db, $query);
                    $count = 0;
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <button id='modallist'><a class='nounderlineedit' id='modallink3'
                        href='editaccessories.php'>Edit</a></button>
                <br>
        ...
        function onButtonClick(id) {
            ...
            a.href = 'editaccessories.php?id=' + id;
        }
        </script>
</body>
